...
<div id="wrapper">
	<!-- start page -->
	<div id="page">
		 <form name ="frm" method="get" action="GenerateModel" onsubmit="return validate(this);">
		<!-- start content -->
		<div id="content">
			<div class="flower"><center><h1>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Training Model Generation Process Screen<h1></div>
			<br/>
			<%
...
<tr><td></td><td><input type="submit" value="Train Model"></td>
</td></tr>
<tr><td><textarea name="t1" rows="40" cols="60">
<%
if(session.getAttribute("output") != null){
	out.println(session.getAttribute("output").toString()+"\n\n"+session.getAttribute("output1").toString());
}
%>
</textarea>
