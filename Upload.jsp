...
<div id="wrapper">
	<!-- start page -->
	<div id="page">
		 <form name ="frm" method="post" action="Upload" enctype="multipart/form-data" onsubmit="return validate(this);">
		<!-- start content -->
		<div id="content">
			<div class="flower"><center><h1>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Upload Dataset Screen<h1></div>
			<br/>
			<%
	...
	out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
		...
		out.println("<center><font size=3 color=red>"+res+"</font></center>");
			...
			<table align="right">
<tr><td><font size="3" color="black">Username</td><td><input type="file" name="t1" size="20"/></td></tr>
 </td></tr>
